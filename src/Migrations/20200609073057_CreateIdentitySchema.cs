        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(maxLength: 40, nullable: true),
                    Description = table.Column<string>(maxLength: 4096, nullable: false),
                    PosterPath = table.Column<string>(maxLength: 64, nullable: true),
                    Producer = table.Column<string>(maxLength: 64, nullable: false),
                    ReleaseDate = table.Column<DateTime>(nullable: false),
                    Timestamp = table.Column<DateTime>(nullable: false),
                    ViewCount = table.Column<int>(nullable: false),
                    UploadedUserId = table.Column<string>(maxLength: 32, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Users_UploadedUserId",
